<div class="profile mar-l-sm pad-t-sm">
    <div class="radius-12 pad-t-big pad-b-big c-bg-cmpnt scrollable">
        ...
        <div class="mar-l-big mar-r-big pad-t-big pad-b-big text-c">
            ...
            <form action="#">
                <button type="submit" onclick="" class="button button-col down radius-12 pad-t-big pad-b-big">Add Image
                    <i class="fa fa-image c-text-pink mar-l-sm"></i>
                </button>
            </form>
            ...
            <form action="#">
                <button type="submit" class="button button-col down radius-12 pad-t-big pad-b-big">Publish
                    <i class="fa fa-cloud-upload c-text-pink login-icon mar-l-sm"></i>
                </button>
            </form>
        </div>
    </div>
